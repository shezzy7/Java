public class A_sortedArrayToBST{
    ...
    public static void main(String args[]){
        ...
        //So here if we make mid value of array and make it root node and values on its left side should be its left subtree and value on its right side should be its right subtree.
    }
}