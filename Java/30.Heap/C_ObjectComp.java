...
public class C_ObjectComp {
            ...
            //For this purpose we use an interface named Comparable.This interface contains a method compareTo which is used for comparing objects on the basis of given attribute.
            ...
            static class Student implements Comparable<Student>{
                ...
                //Now for comparing objects our Comparable interface contains a method compareTo which compares objects.As this method is of parent interface Compareable , so for using it in its child class Student we have to orride it (Overriding : Using methods of a parent class in child class is called overriding)
                ...
                public int compareTo(Student S2){
                    ...
                    //If it returns a negative value then it means that first is smaller then second.for example S1.rank = 5 and S2.rank= 10 . Then it will return a negative value 5-10=-5.
