public class binaryOnesComplenet{
    public static void main(String args[]){
        ...
        //then it will become 00000101 after this we will add 1 in it and after adding 1 it will bwcome 00000110 which is equall to 6 as the MSB was 1 which means the given values was negative so it be -6
