...
public class F_LinkedHashmap{
    ...
    public static void main(String args[]){
        //Linked HashMap is just like hashmap.the difference is that keys are in insertiion order.For example if we put some key value pair and then aanther and so oon .When we will print our hashmap then all the pairs will be in same order as they were added in linkedhashmapp.
