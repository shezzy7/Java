...
public class H_majorityElement{
    ...
    public static void main(String args[]){
        ...
        //output -> 1
        //as n = 9. So n/3=3. So we have to print only those element which are present more then 3 times.So we see that 1 is the onnlly elment which is present more then 3 timme so output will be 1
        // nums[]={1,2}
