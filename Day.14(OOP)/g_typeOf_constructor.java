...
class Pen{
    ...
    Pen(){
        System.out.print("Non-Prametarized constructor");
    }
    ...
    //And we can declare any constructor even if any object in not calling it but we can't declare a object if any constructor is no presenting which matches its arguments 
