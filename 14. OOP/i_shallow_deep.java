public class i_shallow_deep{
    public static void main(String args[]){
        ...
        //now lets print both objects
         ...
         //So this is basically what when we copy a onbject in another object through this method then for arrays no space is allocated for second obbect it just have the reference to values of object 1 maen if we make any changes to  array data through amy object then it will be reflected in both objects .This is the concept of 'shallow copy'.
